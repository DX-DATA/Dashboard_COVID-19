    ...
    if(this.positions != undefined) {
      for(let i = 0; i < this.positions.length; i+=3) {
        position.push({
          ...
          content : "<div class='kakao_map_tooltip' style='box-sizing: unset !important;'>" + this.positions[i].use_timestamp + "</div>",
...
.kakao_map_tooltip::before, .kakao_map_tooltip::after {
  box-sizing: unset !important;
}
</style>